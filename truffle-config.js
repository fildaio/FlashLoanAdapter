...
module.exports = {
  ...
  networks: {
    ...
    hecotest: {
      provider: () => new HDWalletProvider({mnemonic: mnemonicStr, providerOrUrl:`https://http-testnet.hecochain.com`}),
      network_id: 256,   // This network is yours, in the cloud.
      //production: true,    // Treats this network as if it was a public net. (default: false)
      timeoutBlocks: 200
    },
    heco: {
      // https://http-mainnet-node.huobichain.com
      // https://heconode.ifoobar.com
      // https://heconode.filda.io
      provider: () => new HDWalletProvider({mnemonic: mnemonicStr, providerOrUrl:'https://heconode.filda.io'}),
      network_id: 0x80,   // This network is yours, in the cloud.
      //production: true,    // Treats this network as if it was a public net. (default: false)
      timeoutBlocks: 200,
      confirmations: 2,
      gasPrice: 2000000000,
